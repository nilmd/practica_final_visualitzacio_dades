const DataLoader = (function () {
  async function loadCSV(path = "global_power_plant_database.csv") {
    ...
    const data = await d3.csv(path, (d) => {
      ...
      d.country_long = d.country_long || d.country || "Unknown";
      ...
      d.commissioning_year = d.commissioning_year
        ? Math.round(+d.commissioning_year)
        : null;
      ...
      d.other_fuel1 = d.other_fuel1 || "";
      d.other_fuel2 = d.other_fuel2 || "";
      d.other_fuel3 = d.other_fuel3 || "";
      return d;
    });
    return data;
  }
